...
const NarrowSidebar = ({ setNewMessage, setMessageReceiverName, setMessageReceiverUser, newMessageContent, setNewMessageContent, newMessageSubject, setNewMessageSubject }) => {
  return (
