    ...
    <form className='space-y-8 divide-y divide-gray-200'>
      ...
      <div className='sm:col-span-6'>
        ...
        <div className='mt=1 flex items-center'>
          ...
          <button type='button' className='ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 cofus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'>
            Change
          </button>
