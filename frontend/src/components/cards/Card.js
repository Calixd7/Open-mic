...
function Card ({ token, cards, setCards, setMessageReceiverUser, setMessageReceiverName, connections, setConnections, setThreadStatus }) {
                  ...
                  >
                    <span className='mx-2 w-full relative z-0 flex flex-col shadow-sm rounded-md'>
                      ...
                      <div className='relative z-0 inline-flex shadow-sm rounded-md'>
                        ...
                        <MessageBtn card={card} setMessageReceiverUser={setMessageReceiverUser} setMessageReceiverName={setMessageReceiverName} setThreadStatus={setThreadStatus} />
                      </div>
                    </span>
                  </div>
                </div>
